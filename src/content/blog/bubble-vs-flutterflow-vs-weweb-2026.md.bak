...
**The gotcha:** WeWeb's row limits are for the built-in database (Xano-backed). Most serious users pair WeWeb with external backends like Supabase ($25/mo) or Xano ($99/mo). Realistic cost for a production app: $74-150/month for WeWeb Pro + Supabase. [2]
