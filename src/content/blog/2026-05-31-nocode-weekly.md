...
**TL;DR**
- **Webflow** combined CMS and Business plans into a single Premium plan — Business users save $10/mo, CMS users get 10x more items.
...
Webflow rolled out its biggest pricing overhaul in years on May 13, consolidating the CMS and Business Site plans into a single **Premium plan** at $39/mo monthly ($25/mo yearly). The changes take effect for existing sites starting June 29, 2026.

Key changes:
- **Business plan drops $10/mo** — from $49/mo to $39/mo (monthly), or $39/mo → $25/mo (yearly)
...
1. Webflow Help Center — Updated pricing and simplified plans (May 2026): https://help.webflow.com/hc/en-us/articles/51059955082387-Updated-pricing-and-simplified-plans-for-May-2026
2. Crossnode on Product Hunt: https://www.producthunt.com/products/crossnode
3. Microsoft Power Platform Blog — May 2026 feature update: https://www.microsoft.com/en-us/power-platform/blog/2026/05/14/whats-new-in-power-platform-may-2026-feature-update/
4. Microsoft Copilot Blog — Computer-using agents GA: https://www.microsoft.com/en-us/microsoft-copilot/blog/copilot-studio/new-and-improved-computer-using-agents-a-new-workflows-experience-and-real-time-voice-experiences/
5. Make Product Page — Analytics Dashboard and AI agents: https://www.make.com/en/product
6. Tech Funding News — Lemonado raises $1.4M seed: https://techfundingnews.com/lemonado-no-code-platform/
7. Product Hunt — No-code AI agent builder category: https://www.producthunt.com/categories/no-code-ai-agent-builder
8. OnSpace AI on Product Hunt: https://www.producthunt.com/products/onspace-ai-no-code-app-builder
